\begin{center}
	...
	% binary
	\fill[white] (3,2) rectangle (3.5,2.5);
	% \draw[thin] (3.1,2.1) -- (3.4,2.4);
	% \draw[thin] (3.4,2.1) -- (3.1,2.4);
	
	% org binary
	\draw[green!40,thin] (3,2) -- (3.5,2) -- (3.5,2.5) -- (3,2.2) -- (3,2);
	\fill[green!40] (3,2) rectangle (3.5,2.5);
